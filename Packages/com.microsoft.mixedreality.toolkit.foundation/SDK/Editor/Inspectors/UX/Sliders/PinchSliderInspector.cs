    ...
    public class PinchSliderInspector : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            if (slider != null)
            {
                ...
                var fmh_49_21_638057702086363430 = Quaternion.identity; slider.SliderStartPosition = Handles.FreeMoveHandle(startPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
                var fmh_54_21_638057702086389153 = Quaternion.identity; slider.SliderEndPosition = Handles.FreeMoveHandle(endPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
